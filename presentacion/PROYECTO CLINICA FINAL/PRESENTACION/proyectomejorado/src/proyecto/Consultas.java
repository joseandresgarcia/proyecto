...
public class Consultas extends javax.swing.JFrame {
       LogTriaje triaje;
        ...
        pacientes pacientes=new pacientes();//objeto del formulario pacientes
    ...
    public Consultas() {
       ...
       //para cambiar el fondo
        ...
        ImageIcon(this.getClass().getResource("/imagenes/fondoadmision.jpg")); JLabel fondo2= new JLabel();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        pacientes.consultas=this;
        pacientes.setVisible(true);
        this.setVisible(false);
        
        
       /* historiaclinica.consultas=this;
