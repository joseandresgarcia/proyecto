...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2017 a las 03:05:37
...
--
ALTER TABLE `historiaclinica`
  MODIFY `idHistoriaClinica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `pacientes`
  MODIFY `CodigoPaciente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
